      ...
      <div className="min-h-screen xl:pl-72">
        ...
        <section className="mx-auto flex w-full max-w-[1760px] flex-col gap-5 px-4 py-5 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-end justify-between gap-4">
            ...
            <Link
              className="inline-flex h-10 items-center gap-2 rounded-md border border-slate-700 px-3 text-sm font-semibold text-slate-300 hover:bg-slate-800 hover:text-slate-100"
              href="/"
            >
          ...
          <JournalFilters journal={journal} />
...
function JournalFilters({ journal }: { journal: JournalData }) {
  ...
  return (
    <form
      ...
      method="get"
    >
      <div className="grid gap-3 lg:grid-cols-[minmax(18rem,1fr)_12rem_12rem_12rem_8rem_auto]">
        ...
        <div className="flex gap-2">
          ...
          <Link
            className="inline-flex h-10 items-center justify-center rounded-md border border-slate-700 px-3 text-sm font-semibold text-slate-300 hover:bg-slate-800"
            href="/journal"
          >
            Reset
          </Link>
