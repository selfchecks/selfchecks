...
export default function DashboardPage() {
  ...
  const filteredGroups = useMemo<GroupRow[]>(() => {
    ...
    return nextGroups;
  }, [expandedGroups, query, statusFilter, tagFilter, traceOnly, typeFilter]);
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <FilterButton
                ...
                onClick={() =>
                  setTypeFilter((current) => (current === "all" ? "api" : "all"))
                }
              />
              <FilterButton
...
function doesCheckMatchFilters(
  ...
  return (
    ...
    (filters.typeFilter === "all" || filters.typeFilter === "api")
  );
}
